            ...
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr, index) in spuSaleAttrList" :key="index">
                ...
                in spuSaleAttr.spuSaleAttrValueList"
                 :key="index" 
                 @click="changIsChecked(spuSaleAttrValue, spuSaleAttr.spuSaleAttrValueList)">
...
import { mapGetters } from 'vuex'
  ...
  export default {
    ...
    methods:{
      ...
      changIsChecked(spuSaleAttrValue, spuSaleAttrValueList){
     ...
     async addShopCart(){//加入购物车
      ...
      try { 
       ...
       addShopCartss(){
         ...
         this.$store.dispatch('addOrUpdateShopCart',{skuId: this.skuId,skuNum:this.skuNum})
       } 
