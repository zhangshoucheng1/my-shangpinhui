<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="(address, index)
       in userAddressList" :key="index">
      ...
      <div class="bbs">
        ...
        <textarea placeholder="建议留言前先与商家沟通确认"
         class="remarks-cont" v-model="message"></textarea>
  ...
  export default {
    ...
    computed:{
      ...
      ...mapState({
        ...
        userAddressList:state=>state.search.userAddressList,
      }),
